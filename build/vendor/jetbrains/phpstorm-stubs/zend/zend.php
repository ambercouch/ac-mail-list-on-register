...
// Start of Zend Extensions
\class_alias('ACSB\Vendor\ZendAPI_Queue', 'ZendAPI_Queue', \false);
/**
 ...
 * For simplicity, a job can be added directly to a queue and without creating an instant of a Queue object
 */
\class_alias('ACSB\Vendor\ZendAPI_Job', 'ZendAPI_Job', \false);
/**
...
\class_alias('ACSB\Vendor\java', 'java', \false);
class JavaException
{
    /**
...
\class_alias('ACSB\Vendor\JavaException', 'JavaException', \false);

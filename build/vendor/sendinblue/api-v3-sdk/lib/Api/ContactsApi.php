...
class ContactsApi
{
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\PostContactInfo';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\PostContactInfo', $e->getResponseHeaders());
    ...
    protected function addContactToListRequest($listId, $contactEmails)
    {
        ...
        // path params
        if ($listId !== null) {
            $resourcePath = str_replace('{' . 'listId' . '}', ObjectSerializer::toPathValue($listId), $resourcePath);
        }
        // body params
        $_tempBody = null;
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\CreateUpdateContactModel';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\CreateUpdateContactModel', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 204:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\CreateUpdateContactModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\CreateModel';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\CreateModel', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    protected function deleteContactRequest($identifier)
    {
        ...
        // path params
        if ($identifier !== null) {
            $resourcePath = str_replace('{' . 'identifier' . '}', ObjectSerializer::toPathValue($identifier), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    protected function deleteFolderRequest($folderId)
    {
        ...
        // path params
        if ($folderId !== null) {
            $resourcePath = str_replace('{' . 'folderId' . '}', ObjectSerializer::toPathValue($folderId), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetAttributes';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetAttributes', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetExtendedContactDetails';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetExtendedContactDetails', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetContactCampaignStats';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetContactCampaignStats', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetContacts';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetContacts', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetFolder';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetFolder', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetFolderLists';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetFolderLists', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetFolders';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetFolders', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetExtendedList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetExtendedList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetLists';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetLists', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\CreatedProcessId';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 202:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\CreatedProcessId', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\ErrorModel', $e->getResponseHeaders());

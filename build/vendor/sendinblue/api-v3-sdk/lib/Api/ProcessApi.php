...
class ProcessApi
{
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetProcess';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetProcess', $e->getResponseHeaders());
    ...
    protected function getProcessRequest($processId)
    {
        ...
        // path params
        if ($processId !== null) {
            $resourcePath = str_replace('{' . 'processId' . '}', ObjectSerializer::toPathValue($processId), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetProcesses';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetProcesses', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\ErrorModel', $e->getResponseHeaders());

...
class AbTestVersionClicksInner implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['link' => 'string', 'clicksCount' => 'float', 'clickRate' => 'string'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['link' => null, 'clicksCount' => 'int64', 'clickRate' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['link' => 'link', 'clicksCount' => 'clicksCount', 'clickRate' => 'clickRate'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['link' => 'setLink', 'clicksCount' => 'setClicksCount', 'clickRate' => 'setClickRate'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['link' => 'getLink', 'clicksCount' => 'getClicksCount', 'clickRate' => 'getClickRate'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *

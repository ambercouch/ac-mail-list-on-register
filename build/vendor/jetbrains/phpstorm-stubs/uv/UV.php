...
\class_alias('ACSB\Vendor\UV', 'UV', \false);
abstract class UVStream extends \UV
{
}
\class_alias('ACSB\Vendor\UVStream', 'UVStream', \false);
class UVTcp extends \UVStream
{
}
\class_alias('ACSB\Vendor\UVTcp', 'UVTcp', \false);
class UVUdp extends \UV
{
}
\class_alias('ACSB\Vendor\UVUdp', 'UVUdp', \false);
class UVPipe extends \UVStream
{
}
\class_alias('ACSB\Vendor\UVPipe', 'UVPipe', \false);
class UVIdle extends \UV
{
}
\class_alias('ACSB\Vendor\UVIdle', 'UVIdle', \false);
class UVTimer extends \UV
{
}
\class_alias('ACSB\Vendor\UVTimer', 'UVTimer', \false);
class UVAsync extends \UV
{
}
\class_alias('ACSB\Vendor\UVAsync', 'UVAsync', \false);
class UVAddrinfo extends \UV
{
}
\class_alias('ACSB\Vendor\UVAddrinfo', 'UVAddrinfo', \false);
class UVProcess extends \UV
{
}
\class_alias('ACSB\Vendor\UVProcess', 'UVProcess', \false);
class UVPrepare extends \UV
{
}
\class_alias('ACSB\Vendor\UVPrepare', 'UVPrepare', \false);
class UVCheck extends \UV
{
}
\class_alias('ACSB\Vendor\UVCheck', 'UVCheck', \false);
class UVWork extends \UV
{
}
\class_alias('ACSB\Vendor\UVWork', 'UVWork', \false);
class UVFs extends \UV
{
}
\class_alias('ACSB\Vendor\UVFs', 'UVFs', \false);
class UVFsEvent extends \UV
{
}
\class_alias('ACSB\Vendor\UVFsEvent', 'UVFsEvent', \false);
class UVTty extends \UVStream
{
}
\class_alias('ACSB\Vendor\UVTty', 'UVTty', \false);
class UVFsPoll extends \UV
{
}
\class_alias('ACSB\Vendor\UVFsPoll', 'UVFsPoll', \false);
class UVPoll extends \UV
{
}
\class_alias('ACSB\Vendor\UVPoll', 'UVPoll', \false);
class UVSignal extends \UV
{
}
\class_alias('ACSB\Vendor\UVSignal', 'UVSignal', \false);
class UVLoop
{
}
\class_alias('ACSB\Vendor\UVLoop', 'UVLoop', \false);
abstract class UVSockAddr
{
}
\class_alias('ACSB\Vendor\UVSockAddr', 'UVSockAddr', \false);
class UVSockAddrIPv4 extends \UVSockAddr
{
}
\class_alias('ACSB\Vendor\UVSockAddrIPv4', 'UVSockAddrIPv4', \false);
class UVSockAddrIPv6 extends \UVSockAddr
{
}
\class_alias('ACSB\Vendor\UVSockAddrIPv6', 'UVSockAddrIPv6', \false);
class UVLock
{
}
\class_alias('ACSB\Vendor\UVLock', 'UVLock', \false);
class UVStdio
{
}
\class_alias('ACSB\Vendor\UVStdio', 'UVStdio', \false);

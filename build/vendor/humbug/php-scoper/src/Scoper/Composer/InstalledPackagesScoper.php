 ...
 */
namespace ACSB\Vendor\Humbug\PhpScoper\Scoper\Composer;
...
use function ACSB\Vendor\Safe\json_decode;
use function ACSB\Vendor\Safe\json_encode;
...
final readonly class InstalledPackagesScoper implements Scoper
{
    ...
    public function __construct(private Scoper $decoratedScoper, private AutoloadPrefixer $autoloadPrefixer)
    {
    }
    /**

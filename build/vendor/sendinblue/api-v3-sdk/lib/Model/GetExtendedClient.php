...
class GetExtendedClient implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['email' => 'string', 'firstName' => 'string', 'lastName' => 'string', 'companyName' => 'string', 'address' => 'ACSB\Vendor\SendinBlue\Client\Model\GetExtendedClientAddress'];
    /**

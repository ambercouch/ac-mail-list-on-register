 ...
 * @template-implements Iterator<TKey, TYield>
 */
\class_alias('ACSB\Vendor\Generator', 'Generator', \false);
class ClosedGeneratorException extends \Exception
{
}
\class_alias('ACSB\Vendor\ClosedGeneratorException', 'ClosedGeneratorException', \false);
namespace ACSB\Vendor\___PHPSTORM_HELPERS;

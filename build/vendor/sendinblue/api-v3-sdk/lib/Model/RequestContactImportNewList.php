 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RequestContactImportNewList implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['listName' => 'string', 'folderId' => 'int'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['listName' => null, 'folderId' => 'int64'];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['listName' => 'listName', 'folderId' => 'folderId'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['listName' => 'setListName', 'folderId' => 'setFolderId'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['listName' => 'getListName', 'folderId' => 'getFolderId'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *

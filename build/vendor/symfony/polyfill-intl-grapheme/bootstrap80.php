 ...
 */
use ACSB\Vendor\Symfony\Polyfill\Intl\Grapheme as p;
if (!\function_exists('grapheme_str_split') && !\function_exists('ACSB\Vendor\grapheme_str_split')) {
...
if (!\function_exists('grapheme_extract') && !\function_exists('ACSB\Vendor\grapheme_extract')) {
...
if (!\function_exists('grapheme_stripos') && !\function_exists('ACSB\Vendor\grapheme_stripos')) {
...
if (!\function_exists('grapheme_stristr') && !\function_exists('ACSB\Vendor\grapheme_stristr')) {
...
if (!\function_exists('grapheme_strlen') && !\function_exists('ACSB\Vendor\grapheme_strlen')) {
    function grapheme_strlen(?string $string): int|false|null
    {
        return p\Grapheme::grapheme_strlen((string) $string);
    }
}
if (!\function_exists('grapheme_strpos') && !\function_exists('ACSB\Vendor\grapheme_strpos')) {
...
if (!\function_exists('grapheme_strripos') && !\function_exists('ACSB\Vendor\grapheme_strripos')) {
...
if (!\function_exists('grapheme_strrpos') && !\function_exists('ACSB\Vendor\grapheme_strrpos')) {
...
if (!\function_exists('grapheme_strstr') && !\function_exists('ACSB\Vendor\grapheme_strstr')) {
...
if (!\function_exists('grapheme_substr') && !\function_exists('ACSB\Vendor\grapheme_substr')) {

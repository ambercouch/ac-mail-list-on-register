 ...
 */
namespace ACSB\Vendor\Humbug\PhpScoper\Scoper;
...
final readonly class PhpScoper implements Scoper
{
    ...
    public function __construct(private Parser $parser, private Scoper $decoratedScoper, private TraverserFactory $traverserFactory, private Printer $printer)
    {
    }
    /**
     * Scopes PHP files.

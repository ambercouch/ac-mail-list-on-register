 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('ACSB\Vendor\LuaSandbox', 'LuaSandbox', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('ACSB\Vendor\LuaSandboxFunction', 'LuaSandboxFunction', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('ACSB\Vendor\LuaSandboxError', 'LuaSandboxError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('ACSB\Vendor\LuaSandboxRuntimeError', 'LuaSandboxRuntimeError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('ACSB\Vendor\LuaSandboxFatalError', 'LuaSandboxFatalError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('ACSB\Vendor\LuaSandboxErrorError', 'LuaSandboxErrorError', \false);
/**
 ...
 * @see LuaSandbox::setMemoryLimit()
 */
\class_alias('ACSB\Vendor\LuaSandboxMemoryError', 'LuaSandboxMemoryError', \false);
/**
 ...
 * @since luasandbox >= 1.0.0
 */
\class_alias('ACSB\Vendor\LuaSandboxSyntaxError', 'LuaSandboxSyntaxError', \false);
/**
 ...
 * @see LuaSandbox::setCPULimit()
 */
\class_alias('ACSB\Vendor\LuaSandboxTimeoutError', 'LuaSandboxTimeoutError', \false);

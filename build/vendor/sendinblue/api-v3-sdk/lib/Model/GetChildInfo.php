...
class GetChildInfo implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['email' => 'string', 'firstName' => 'string', 'lastName' => 'string', 'companyName' => 'string', 'credits' => 'ACSB\Vendor\SendinBlue\Client\Model\GetChildInfoCredits', 'statistics' => 'ACSB\Vendor\SendinBlue\Client\Model\GetChildInfoStatistics', 'password' => 'string', 'ips' => 'string[]', 'apiKeys' => 'ACSB\Vendor\SendinBlue\Client\Model\GetChildInfoApiKeys'];
    /**

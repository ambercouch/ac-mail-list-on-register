...
class RequestContactExport implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['exportAttributes' => 'string[]', 'contactFilter' => 'object', 'customContactFilter' => 'ACSB\Vendor\SendinBlue\Client\Model\RequestContactExportCustomContactFilter', 'notifyUrl' => 'string'];
    /**

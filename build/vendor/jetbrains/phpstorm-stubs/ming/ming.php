...
// Start of ming v.
\class_alias('ACSB\Vendor\SWFShape', 'SWFShape', \false);
class SWFFill
{
    public function __construct()
    {
...
\class_alias('ACSB\Vendor\SWFFill', 'SWFFill', \false);
class SWFGradient
{
    public function __construct()
    {
...
\class_alias('ACSB\Vendor\SWFGradient', 'SWFGradient', \false);
class SWFBitmap
{
    public function __construct()
    {
...
\class_alias('ACSB\Vendor\SWFBitmap', 'SWFBitmap', \false);
class SWFText
{
    public function __construct()
    {
...
\class_alias('ACSB\Vendor\SWFText', 'SWFText', \false);
class SWFTextField
{
    public function __construct()
    {
...
\class_alias('ACSB\Vendor\SWFTextField', 'SWFTextField', \false);
class SWFFont
{
    public function __construct()
    {
...
\class_alias('ACSB\Vendor\SWFFont', 'SWFFont', \false);
...
\class_alias('ACSB\Vendor\SWFDisplayItem', 'SWFDisplayItem', \false);
class SWFMovie
{
    public function __construct()
    {
...
\class_alias('ACSB\Vendor\SWFMovie', 'SWFMovie', \false);
class SWFButton
{
    public function __construct()
    {
...
\class_alias('ACSB\Vendor\SWFButton', 'SWFButton', \false);
class SWFAction
{
    public function __construct()
    {
...
\class_alias('ACSB\Vendor\SWFAction', 'SWFAction', \false);
class SWFMorph
{
    public function __construct()
    {
...
\class_alias('ACSB\Vendor\SWFMorph', 'SWFMorph', \false);
class SWFSprite
{
    public function __construct()
    {
...
\class_alias('ACSB\Vendor\SWFSprite', 'SWFSprite', \false);
class SWFSound
{
    public function __construct()
    {
...
\class_alias('ACSB\Vendor\SWFSound', 'SWFSound', \false);
class SWFFontChar
{
    public function addChars()
    {
...
\class_alias('ACSB\Vendor\SWFFontChar', 'SWFFontChar', \false);
...
\class_alias('ACSB\Vendor\SWFSoundInstance', 'SWFSoundInstance', \false);
...
\class_alias('ACSB\Vendor\SWFVideoStream', 'SWFVideoStream', \false);
/**
 * Set cubic threshold

...
use ACSB\Vendor\Humbug\PhpScoper\NotInstantiable;
final class ConfigurationKeys
{
    ...
    {
        return in_array($key, self::KEYWORDS, \true);
    }
}

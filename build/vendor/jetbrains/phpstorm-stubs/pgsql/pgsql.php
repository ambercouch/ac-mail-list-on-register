...
function pg_connect_poll(
    ...
    $connection = null,
    #[PhpStormStubsElementAvailable(from: '8.0')]
    #[LanguageLevelTypeAware(['8.1' => 'ACSB\Vendor\PgSql\Connection'], default: 'resource')]
    $connection
): int
{
}
...
function pg_fetch_result(
    #[LanguageLevelTypeAware(['8.1' => 'ACSB\Vendor\PgSql\Result'], default: 'resource')]
    $result,
    #[PhpStormStubsElementAvailable(from: '5.3', to: '7.4')]
    $row = 0,
    #[PhpStormStubsElementAvailable(from: '8.0')]
...
function pg_lo_close(
    #[LanguageLevelTypeAware(['8.1' => 'ACSB\Vendor\PgSql\Lob'], default: 'resource')]
    $lob
): bool
{
}

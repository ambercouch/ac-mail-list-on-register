 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateSmsCampaign implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['name' => 'string', 'sender' => 'string', 'content' => 'string', 'recipients' => 'ACSB\Vendor\SendinBlue\Client\Model\CreateSmsCampaignRecipients', 'scheduledAt' => 'string'];
    /**

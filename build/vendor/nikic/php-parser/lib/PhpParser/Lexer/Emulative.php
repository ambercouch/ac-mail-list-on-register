...
namespace ACSB\Vendor\PhpParser\Lexer;

use ACSB\Vendor\PhpParser\Error;
use ACSB\Vendor\PhpParser\ErrorHandler;
use ACSB\Vendor\PhpParser\Lexer;
use ACSB\Vendor\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use ACSB\Vendor\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ACSB\Vendor\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ACSB\Vendor\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ACSB\Vendor\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ACSB\Vendor\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ACSB\Vendor\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use ACSB\Vendor\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use ACSB\Vendor\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ACSB\Vendor\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ACSB\Vendor\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ACSB\Vendor\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use ACSB\Vendor\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;

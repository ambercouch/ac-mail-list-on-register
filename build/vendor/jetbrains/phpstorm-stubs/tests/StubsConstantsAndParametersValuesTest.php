...
class StubsConstantsAndParametersValuesTest extends AbstractBaseStubsTestCase
{
    ...
    public function testFunctionsDefaultParametersValue(?string $functionId, ?string $parameterName)
    {
        ...
        self::assertEquals($reflectionValue, $stubValue, sprintf('Reflection function %s has optional parameter %s with default value "%s" but stub parameter has value "%s"', $functionId, $reflectionParameter->name, $reflectionValue, $stubValue));
    }
    ...
    public function testFunctionsWithoutOptionalDefaultParametersValue(?string $functionId, ?string $parameterName)
    {
        ...
        /** @var PHPParameter $stubOptionalParameter */
        $stubOptionalParameter = array_pop($stubParameters);
        self::assertEmpty($stubOptionalParameter->defaultValue, sprintf('Stub function "%s" has a parameter "%s" which expected to have no default value but it has', $functionId, $stubOptionalParameter->name));
        self::assertTrue($stubOptionalParameter->markedOptionalInPhpDoc, sprintf('Stub function "%s" has a parameter "%s" which expected to be marked as [optional] at PHPDoc but it is not', $functionId, $stubOptionalParameter->name));
    }

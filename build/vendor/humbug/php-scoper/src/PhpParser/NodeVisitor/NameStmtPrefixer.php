...
use ACSB\Vendor\Humbug\PhpScoper\PhpParser\NodeVisitor\Resolver\OriginalNameResolver;
use ACSB\Vendor\Humbug\PhpScoper\PhpParser\NodeVisitor\UseStmt\UseStmtCollection;
use ACSB\Vendor\Humbug\PhpScoper\PhpParser\UseStmtName;
use ACSB\Vendor\Humbug\PhpScoper\Symbol\EnrichedReflector;
use ACSB\Vendor\PhpParser\Node;
use ACSB\Vendor\PhpParser\Node\Attribute;
use ACSB\Vendor\PhpParser\Node\Expr\ArrowFunction;
use ACSB\Vendor\PhpParser\Node\Expr\ClassConstFetch;
use ACSB\Vendor\PhpParser\Node\Expr\Closure;
use ACSB\Vendor\PhpParser\Node\Expr\ConstFetch;
use ACSB\Vendor\PhpParser\Node\Expr\FuncCall;
use ACSB\Vendor\PhpParser\Node\Expr\Instanceof_;
use ACSB\Vendor\PhpParser\Node\Expr\New_;
use ACSB\Vendor\PhpParser\Node\Expr\StaticCall;
use ACSB\Vendor\PhpParser\Node\Expr\StaticPropertyFetch;
use ACSB\Vendor\PhpParser\Node\IntersectionType;
use ACSB\Vendor\PhpParser\Node\Name;
use ACSB\Vendor\PhpParser\Node\Name\FullyQualified;
use ACSB\Vendor\PhpParser\Node\NullableType;
use ACSB\Vendor\PhpParser\Node\Param;
use ACSB\Vendor\PhpParser\Node\Stmt\Catch_;
...
use ACSB\Vendor\PhpParser\Node\Stmt\Property;
use ACSB\Vendor\PhpParser\Node\Stmt\TraitUse;
use ACSB\Vendor\PhpParser\Node\Stmt\TraitUseAdaptation\Alias;
use ACSB\Vendor\PhpParser\Node\Stmt\TraitUseAdaptation\Precedence;
use ACSB\Vendor\PhpParser\Node\Stmt\Use_;
use ACSB\Vendor\PhpParser\Node\UnionType;
...
final class NameStmtPrefixer extends NodeVisitorAbstract
{
    ...
    private static function doesNameBelongToNamespace(Name $originalName, Name $resolvedName, ?Name $namespaceName): bool
    {
        ...
        $originalNameFQParts = [...$namespaceName->getParts(), ...$originalName->getParts()];

 ...
 */
namespace ACSB\Vendor\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'ACSB\Vendor\mes\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'ACSB\Vendor\Mes\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'ACSB\Vendor\ma\1'],
        ['/^Mes(dame|demoiselle)s$/', 'ACSB\Vendor\Ma\1'],
        ['/^mes(sieur|seigneur)s$/', 'ACSB\Vendor\mon\1'],
        ['/^Mes(sieur|seigneur)s$/', 'ACSB\Vendor\Mon\1'],
        // Default rule
        ['/s$/i', ''],
    ];

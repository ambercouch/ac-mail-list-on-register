...
class SendersApi
{
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\CreateSenderModel';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\CreateSenderModel', $e->getResponseHeaders());
    ...
    {
        return $this->createSenderAsyncWithHttpInfo($sender)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->deleteSenderAsyncWithHttpInfo($senderId)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    protected function deleteSenderRequest($senderId)
    {
        ...
        // path params
        if ($senderId !== null) {
            $resourcePath = str_replace('{' . 'senderId' . '}', ObjectSerializer::toPathValue($senderId), $resourcePath);
        }
        // body params
        $_tempBody = null;
        if ($multipart) {
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetIps';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetIps', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->getIpsAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetIpsFromSender';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetIpsFromSender', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getIpsFromSenderAsyncWithHttpInfo($senderId)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetSendersList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetSendersList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        return $this->getSendersAsyncWithHttpInfo($ip, $domain)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->updateSenderAsyncWithHttpInfo($senderId, $sender)->then(function ($response) {
            return $response[0];
        });
    }
    /**

...
use ACSB\Vendor\Safe\Exceptions\UodbcException;
/**
 ...
 *
 */
function odbc_autocommit(\ACSB\Vendor\Odbc\Connection $odbc, ?bool $enable = null)
{
    error_clear_last();
    if ($enable !== null) {
 ...
 *
 */
function odbc_columnprivileges(\ACSB\Vendor\Odbc\Connection $odbc, string $catalog, string $schema, string $table, string $column)
{
    error_clear_last();
 ...
 *
 */
function odbc_columns(\ACSB\Vendor\Odbc\Connection $odbc, ?string $catalog = null, ?string $schema = null, ?string $table = null, ?string $column = null)
{
    error_clear_last();
    if ($column !== null) {
 ...
 *
 */
function odbc_commit(\ACSB\Vendor\Odbc\Connection $odbc): void
{
    error_clear_last();
 ...
 *
 */
function odbc_connect(string $dsn, ?string $user = null, ?string $password = null, int $cursor_option = \SQL_CUR_USE_DRIVER): \ACSB\Vendor\Odbc\Connection
{
    error_clear_last();
 ...
 *
 */
function odbc_cursor(\ACSB\Vendor\Odbc\Result $statement): string
{
    error_clear_last();
 ...
 *
 */
function odbc_data_source(\ACSB\Vendor\Odbc\Connection $odbc, int $fetch_type): array
{
    error_clear_last();
 ...
 *
 */
function odbc_exec(\ACSB\Vendor\Odbc\Connection $odbc, string $query): \ACSB\Vendor\Odbc\Result
{
    error_clear_last();
 ...
 *
 */
function odbc_execute(\ACSB\Vendor\Odbc\Result $statement, array $params = []): void
{
    error_clear_last();
 ...
 *
 */
function odbc_fetch_into(\ACSB\Vendor\Odbc\Result $statement, ?array &$array, ?int $row = null): int
{
    error_clear_last();
    if ($row !== null) {
 ...
 *
 */
function odbc_field_len(\ACSB\Vendor\Odbc\Result $statement, int $field): int
{
    error_clear_last();
 ...
 *
 */
function odbc_field_name(\ACSB\Vendor\Odbc\Result $statement, int $field): string
{
    error_clear_last();
 ...
 *
 */
function odbc_field_num(\ACSB\Vendor\Odbc\Result $statement, string $field): int
{
    error_clear_last();
 ...
 *
 */
function odbc_field_scale(\ACSB\Vendor\Odbc\Result $statement, int $field): int
{
    error_clear_last();
 ...
 *
 */
function odbc_field_type(\ACSB\Vendor\Odbc\Result $statement, int $field): string
{
    error_clear_last();
 ...
 *
 */
function odbc_foreignkeys(\ACSB\Vendor\Odbc\Connection $odbc, string $pk_catalog, string $pk_schema, string $pk_table, string $fk_catalog, string $fk_schema, string $fk_table)
{
    error_clear_last();
 ...
 *
 */
function odbc_gettypeinfo(\ACSB\Vendor\Odbc\Connection $odbc, int $data_type = 0)
{
    error_clear_last();
 ...
 *
 */
function odbc_longreadlen(\ACSB\Vendor\Odbc\Result $statement, int $length): bool
{
    error_clear_last();
 ...
 *
 */
function odbc_num_fields(\ACSB\Vendor\Odbc\Result $statement): int
{
    error_clear_last();
 ...
 *
 */
function odbc_pconnect(string $dsn, ?string $user = null, ?string $password = null, int $cursor_option = \SQL_CUR_USE_DRIVER): \ACSB\Vendor\Odbc\Connection
{
    error_clear_last();
    if ($cursor_option !== \SQL_CUR_USE_DRIVER) {
 ...
 *
 */
function odbc_prepare(\ACSB\Vendor\Odbc\Connection $odbc, string $query): \ACSB\Vendor\Odbc\Result
{
    error_clear_last();
 ...
 *
 */
function odbc_primarykeys(\ACSB\Vendor\Odbc\Connection $odbc, string $catalog, string $schema, string $table)
{
    error_clear_last();
 ...
 *
 */
function odbc_procedures($odbc, ?string $catalog = null, ?string $schema = null, ?string $procedure = null): \ACSB\Vendor\Odbc\Result
{
    error_clear_last();
    if ($procedure !== null) {
 ...
 *
 */
function odbc_result_all(\ACSB\Vendor\Odbc\Result $statement, string $format = ""): int
{
    error_clear_last();
 ...
 *
 */
function odbc_result(\ACSB\Vendor\Odbc\Result $statement, $field)
{
    error_clear_last();
 ...
 *
 */
function odbc_rollback(\ACSB\Vendor\Odbc\Connection $odbc): void
{
    error_clear_last();
 ...
 *
 */
function odbc_specialcolumns(\ACSB\Vendor\Odbc\Connection $odbc, int $type, string $catalog, string $schema, string $table, int $scope, int $nullable)
{
    error_clear_last();
 ...
 *
 */
function odbc_statistics(\ACSB\Vendor\Odbc\Connection $odbc, string $catalog, string $schema, string $table, int $unique, int $accuracy)
{
    error_clear_last();
 ...
 *
 */
function odbc_tableprivileges(\ACSB\Vendor\Odbc\Connection $odbc, string $catalog, string $schema, string $table)
{
    error_clear_last();
 ...
 *
 */
function odbc_tables(\ACSB\Vendor\Odbc\Connection $odbc, ?string $catalog = null, ?string $schema = null, ?string $table = null, ?string $types = null): \ACSB\Vendor\Odbc\Result
{
    error_clear_last();
    if ($types !== null) {

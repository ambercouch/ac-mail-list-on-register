...
use ACSB\Vendor\JetBrains\PhpStorm\Internal\PhpStormStubsElementAvailable as PhpStormStubsElementAvailable;
 ...
 * @link https://php.net/manual/en/class.tidy.php
 */
\class_alias('ACSB\Vendor\tidy', 'tidy', \false);
/**
 * An HTML node in an HTML file, as detected by tidy.
 ...
 * @link https://php.net/manual/en/class.tidynode.php
 */
\class_alias('ACSB\Vendor\tidyNode', 'tidyNode', \false);
/**
 * (PHP 5, PECL tidy &gt;= 0.5.2)<br/>
 * Returns the value of the specified configuration option for the tidy document
 * @link https://php.net/manual/en/tidy.getopt.php

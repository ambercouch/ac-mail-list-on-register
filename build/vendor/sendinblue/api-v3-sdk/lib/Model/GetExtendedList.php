...
class GetExtendedList implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['id' => 'int', 'name' => 'string', 'totalBlacklisted' => 'int', 'totalSubscribers' => 'int', 'uniqueSubscribers' => 'int', 'folderId' => 'int', 'createdAt' => 'string', 'campaignStats' => '\SendinBlue\Client\Model\GetExtendedListCampaignStats[]', 'dynamicList' => 'bool'];
    /**

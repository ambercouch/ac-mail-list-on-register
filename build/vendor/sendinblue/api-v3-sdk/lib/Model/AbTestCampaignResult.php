...
class AbTestCampaignResult implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['winningVersion' => 'string', 'winningCriteria' => 'string', 'winningSubjectLine' => 'string', 'openRate' => 'string', 'clickRate' => 'string', 'winningVersionRate' => 'string', 'statistics' => 'ACSB\Vendor\SendinBlue\Client\Model\AbTestCampaignResultStatistics', 'clickedLinks' => 'ACSB\Vendor\SendinBlue\Client\Model\AbTestCampaignResultClickedLinks'];
    /**

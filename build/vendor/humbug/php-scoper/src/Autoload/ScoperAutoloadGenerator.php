...
PHP;
    ...
    public function __construct(private readonly SymbolsRegistry $registry, private readonly array $excludedComposerAutoloadFileHashes)
    {
        self::$eol = chr(10);
    }
    public function dump(): string
    {
        ...
        $excludedComposerAutoloadFiles = count($this->excludedComposerAutoloadFileHashes) === 0 ? '[]' : sprintf("['%s']", implode("', '", $this->excludedComposerAutoloadFileHashes));
        if ($wrapInNamespace) {
            $dump = <<<PHP
<?php

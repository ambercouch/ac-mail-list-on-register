...
class AccountApi
{
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetAccount';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetAccount', $e->getResponseHeaders());

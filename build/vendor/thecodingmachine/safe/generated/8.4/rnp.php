...
use ACSB\Vendor\Safe\Exceptions\RnpException;
/**
 ...
 *
 */
function rnp_decrypt(\ACSB\Vendor\RnpFFI $ffi, string $input): string
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_decrypt($ffi, $input);
    if ($safeResult === \false) {
...
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_dump_packets_to_json($input, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
...
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_dump_packets($input, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_ffi_create(string $pub_format, string $sec_format): \ACSB\Vendor\RnpFFI
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_ffi_create($pub_format, $sec_format);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_ffi_set_pass_provider(\ACSB\Vendor\RnpFFI $ffi, callable $password_callback): void
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_ffi_set_pass_provider($ffi, $password_callback);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
}
 ...
 *
 */
function rnp_import_keys(\ACSB\Vendor\RnpFFI $ffi, string $input, int $flags): string
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_import_keys($ffi, $input, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_import_signatures(\ACSB\Vendor\RnpFFI $ffi, string $input, int $flags): string
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_import_signatures($ffi, $input, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_key_export_autocrypt(\ACSB\Vendor\RnpFFI $ffi, string $key_fp, string $subkey_fp, string $uid, int $flags): string
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_key_export_autocrypt($ffi, $key_fp, $subkey_fp, $uid, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_key_export_revocation(\ACSB\Vendor\RnpFFI $ffi, string $key_fp, int $flags, ?array $options = null): string
{
    error_clear_last();
    if ($options !== null) {
        $safeResult = \ACSB\Vendor\rnp_key_export_revocation($ffi, $key_fp, $flags, $options);
    } else {
        $safeResult = \ACSB\Vendor\rnp_key_export_revocation($ffi, $key_fp, $flags);
    }
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
 ...
 *
 */
function rnp_key_export(\ACSB\Vendor\RnpFFI $ffi, string $key_fp, int $flags): string
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_key_export($ffi, $key_fp, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_key_get_info(\ACSB\Vendor\RnpFFI $ffi, string $key_fp): array
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_key_get_info($ffi, $key_fp);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_key_remove(\ACSB\Vendor\RnpFFI $ffi, string $key_fp, int $flags): void
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_key_remove($ffi, $key_fp, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
}
 ...
 *
 */
function rnp_key_revoke(\ACSB\Vendor\RnpFFI $ffi, string $key_fp, int $flags, ?array $options = null): void
{
    error_clear_last();
    if ($options !== null) {
        $safeResult = \ACSB\Vendor\rnp_key_revoke($ffi, $key_fp, $flags, $options);
    } else {
        $safeResult = \ACSB\Vendor\rnp_key_revoke($ffi, $key_fp, $flags);
    }
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
 ...
 *
 */
function rnp_list_keys(\ACSB\Vendor\RnpFFI $ffi, string $identifier_type): array
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_list_keys($ffi, $identifier_type);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_load_keys_from_path(\ACSB\Vendor\RnpFFI $ffi, string $format, string $input_path, int $flags): void
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_load_keys_from_path($ffi, $format, $input_path, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
}
 ...
 *
 */
function rnp_load_keys(\ACSB\Vendor\RnpFFI $ffi, string $format, string $input, int $flags): void
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_load_keys($ffi, $format, $input, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
}
 ...
 *
 */
function rnp_locate_key(\ACSB\Vendor\RnpFFI $ffi, string $identifier_type, string $identifier): string
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_locate_key($ffi, $identifier_type, $identifier);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_op_encrypt(\ACSB\Vendor\RnpFFI $ffi, string $message, array $recipient_keys_fp, ?array $options = null): string
{
    error_clear_last();
    if ($options !== null) {
        $safeResult = \ACSB\Vendor\rnp_op_encrypt($ffi, $message, $recipient_keys_fp, $options);
    } else {
        $safeResult = \ACSB\Vendor\rnp_op_encrypt($ffi, $message, $recipient_keys_fp);
    }
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
 ...
 *
 */
function rnp_op_generate_key(\ACSB\Vendor\RnpFFI $ffi, string $userid, string $key_alg, ?string $sub_alg = null, ?array $options = null): string
{
    error_clear_last();
    if ($options !== null) {
        $safeResult = \ACSB\Vendor\rnp_op_generate_key($ffi, $userid, $key_alg, $sub_alg, $options);
    } elseif ($sub_alg !== null) {
        $safeResult = \ACSB\Vendor\rnp_op_generate_key($ffi, $userid, $key_alg, $sub_alg);
    } else {
        $safeResult = \ACSB\Vendor\rnp_op_generate_key($ffi, $userid, $key_alg);
    }
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
 ...
 *
 */
function rnp_op_sign_cleartext(\ACSB\Vendor\RnpFFI $ffi, string $data, array $keys_fp, ?array $options = null): string
{
    error_clear_last();
    if ($options !== null) {
        $safeResult = \ACSB\Vendor\rnp_op_sign_cleartext($ffi, $data, $keys_fp, $options);
    } else {
        $safeResult = \ACSB\Vendor\rnp_op_sign_cleartext($ffi, $data, $keys_fp);
    }
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
 ...
 *
 */
function rnp_op_sign_detached(\ACSB\Vendor\RnpFFI $ffi, string $data, array $keys_fp, ?array $options = null): string
{
    error_clear_last();
    if ($options !== null) {
        $safeResult = \ACSB\Vendor\rnp_op_sign_detached($ffi, $data, $keys_fp, $options);
    } else {
        $safeResult = \ACSB\Vendor\rnp_op_sign_detached($ffi, $data, $keys_fp);
    }
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
 ...
 *
 */
function rnp_op_sign(\ACSB\Vendor\RnpFFI $ffi, string $data, array $keys_fp, ?array $options = null): string
{
    error_clear_last();
    if ($options !== null) {
        $safeResult = \ACSB\Vendor\rnp_op_sign($ffi, $data, $keys_fp, $options);
    } else {
        $safeResult = \ACSB\Vendor\rnp_op_sign($ffi, $data, $keys_fp);
    }
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
 ...
 *
 */
function rnp_op_verify_detached(\ACSB\Vendor\RnpFFI $ffi, string $data, string $signature): array
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_op_verify_detached($ffi, $data, $signature);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_op_verify(\ACSB\Vendor\RnpFFI $ffi, string $data): array
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_op_verify($ffi, $data);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;
 ...
 *
 */
function rnp_save_keys_to_path(\ACSB\Vendor\RnpFFI $ffi, string $format, string $output_path, int $flags): void
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_save_keys_to_path($ffi, $format, $output_path, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
}
 ...
 *
 */
function rnp_save_keys(\ACSB\Vendor\RnpFFI $ffi, string $format, string &$output, int $flags): void
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_save_keys($ffi, $format, $output, $flags);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $safeResult = \ACSB\Vendor\rnp_supported_features($type);
    if ($safeResult === \false) {
        throw RnpException::createFromPhpError();
    }
    return $safeResult;

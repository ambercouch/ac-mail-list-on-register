 ...
 * created using:
 */
\class_alias('ACSB\Vendor\classObj', 'classObj', \false);
/**
 ...
 * Instance of clusterObj is always embedded inside the `layerObj`_.
 */
\class_alias('ACSB\Vendor\clusterObj', 'clusterObj', \false);
/**
 ...
 * Instances of colorObj are always embedded inside other classes.
 */
\class_alias('ACSB\Vendor\colorObj', 'colorObj', \false);
...
\class_alias('ACSB\Vendor\errorObj', 'errorObj', \false);
/**
 ...
 * $oLayer->grid->set("labelformat", "DDMMSS");
 */
\class_alias('ACSB\Vendor\gridObj', 'gridObj', \false);
/**
 ...
 * echo "Key: ".$key." value: ".$hashTable->get($key)."<br/>";
 */
\class_alias('ACSB\Vendor\hashTableObj', 'hashTableObj', \false);
/**
 ...
 * Instances of imageObj are always created by the `mapObj`_ class methods.
 */
\class_alias('ACSB\Vendor\imageObj', 'imageObj', \false);
...
\class_alias('ACSB\Vendor\labelcacheMemberObj', 'labelcacheMemberObj', \false);
...
\class_alias('ACSB\Vendor\labelcacheObj', 'labelcacheObj', \false);
/**
 ...
 * labelObj are always embedded inside other classes.
 */
\class_alias('ACSB\Vendor\labelObj', 'labelObj', \false);
/**
 ...
 * layer created.
 */
\class_alias('ACSB\Vendor\layerObj', 'layerObj', \false);
/**
 ...
 * Instances of legendObj are always are always embedded inside the `mapObj`_.
 */
\class_alias('ACSB\Vendor\legendObj', 'legendObj', \false);
final class lineObj
{
    /**
     * read-only
...
\class_alias('ACSB\Vendor\lineObj', 'lineObj', \false);
final class mapObj
{
    /**
     * @var float
...
\class_alias('ACSB\Vendor\mapObj', 'mapObj', \false);
/**
 ...
 * No constructor available (coming soon, see ticket 979)
 */
\class_alias('ACSB\Vendor\outputformatObj', 'outputformatObj', \false);
...
\class_alias('ACSB\Vendor\OwsrequestObj', 'OwsrequestObj', \false);
...
\class_alias('ACSB\Vendor\pointObj', 'pointObj', \false);
...
\class_alias('ACSB\Vendor\projectionObj', 'projectionObj', \false);
/**
 ...
 * `mapObj`_.
 */
\class_alias('ACSB\Vendor\querymapObj', 'querymapObj', \false);
/**
 ...
 * also be created with:
 */
\class_alias('ACSB\Vendor\rectObj', 'rectObj', \false);
/**
 ...
 * Instances of referenceMapObj are always embedded inside the `mapObj`_.
 */
\class_alias('ACSB\Vendor\referenceMapObj', 'referenceMapObj', \false);
...
\class_alias('ACSB\Vendor\resultObj', 'resultObj', \false);
/**
 ...
 * Instances of scalebarObj are always embedded inside the `mapObj`_.
 */
\class_alias('ACSB\Vendor\scalebarObj', 'scalebarObj', \false);
...
\class_alias('ACSB\Vendor\shapefileObj', 'shapefileObj', \false);
...
\class_alias('ACSB\Vendor\shapeObj', 'shapeObj', \false);
/**
 ...
 * Instances of styleObj are always embedded inside a `classObj`_ or `labelObj`_.
 */
\class_alias('ACSB\Vendor\styleObj', 'styleObj', \false);
...
\class_alias('ACSB\Vendor\symbolObj', 'symbolObj', \false);
/**
 ...
 * Instances of webObj are always are always embedded inside the `mapObj`_.
 */
\class_alias('ACSB\Vendor\webObj', 'webObj', \false);

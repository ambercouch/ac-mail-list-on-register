...
final class Configuration
{
     ...
     */
    public function __construct(private ?string $path, private ?string $outputDir, string|Prefix $prefix, private ?PhpVersion $phpVersion, private array $filesWithContents, private array $excludedFilesWithContents, private Patcher $patcher, private SymbolsConfiguration $symbolsConfiguration)
    {
        $this->prefix = $prefix instanceof Prefix ? $prefix : new Prefix($prefix);
    }
    /**
    ...
    {
        return new self($this->path, $this->outputDir, $prefix, $this->phpVersion, $this->filesWithContents, $this->excludedFilesWithContents, $this->patcher, $this->symbolsConfiguration);
    }
    /**
    ...
    {
        return new self($this->path, $this->outputDir, $this->prefix, $this->phpVersion, $filesWithContents, $this->excludedFilesWithContents, $this->patcher, $this->symbolsConfiguration);
    }
    /**
    ...
    {
        return new self($this->path, $this->outputDir, $this->prefix, $this->phpVersion, $this->filesWithContents, $this->excludedFilesWithContents, $patcher, $this->symbolsConfiguration);
    }

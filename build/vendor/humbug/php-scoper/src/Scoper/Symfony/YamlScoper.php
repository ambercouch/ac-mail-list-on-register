 ...
 */
namespace ACSB\Vendor\Humbug\PhpScoper\Scoper\Symfony;
...
final readonly class YamlScoper implements Scoper
{
    ...
    public function __construct(private Scoper $decoratedScoper, private string $prefix, private EnrichedReflector $enrichedReflector, private SymbolsRegistry $symbolsRegistry)
    {
    }

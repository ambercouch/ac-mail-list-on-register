...
final class LazyCommandEnvelope
{
     ...
     */
    public function __construct(public readonly string $name, public readonly string $description, public readonly Closure $factory)
    {
    }
    /**
    ...
    {
        return new self($commandClassName::getName(), $commandClassName::getDescription(), $factory);
    }
}

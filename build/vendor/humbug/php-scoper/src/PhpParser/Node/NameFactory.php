...
final class NameFactory
{
     ...
     */
    public static function concat(array|Name|string|null $name1, array|Name|string|null $name2, ?array $attributes = null): Name
    {
     ...
     */
    public static function getConcatenatedNamesAttributes(string|array|Name|null $name1, string|array|Name|null $name2, ?array $attributes = null): array
    {
        return match (\true) {

...
final readonly class InitCommand implements Command
{
    ...
    public function __construct(private Filesystem $fileSystem, private FormatterHelper $formatterHelper)
    {
    }
    public function getConfiguration(): CommandConfiguration
    {
        return new CommandConfiguration('init', 'Generates a configuration file.', '', [], [ChangeableDirectory::createOption(), new InputOption(self::CONFIG_FILE_OPT, 'c', InputOption::VALUE_REQUIRED, sprintf('Configuration file. Will use "%s" if found by default.', self::CONFIG_FILE_DEFAULT), null)]);
    }

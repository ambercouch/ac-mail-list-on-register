...
class TransactionalSMSApi
{
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetSmsEventReport';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetSmsEventReport', $e->getResponseHeaders());
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetTransacAggregatedSmsReport';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetTransacAggregatedSmsReport', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\GetTransacSmsReport';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\GetTransacSmsReport', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\ErrorModel', $e->getResponseHeaders());
    ...
    {
        $returnType = 'ACSB\Vendor\SendinBlue\Client\Model\SendSms';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\SendSms', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'ACSB\Vendor\SendinBlue\Client\Model\ErrorModel', $e->getResponseHeaders());

...
use ACSB\Vendor\GuzzleHttp\Cookie\CookieJar;
use ACSB\Vendor\GuzzleHttp\Exception\GuzzleException;
use ACSB\Vendor\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \ACSB\Vendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**

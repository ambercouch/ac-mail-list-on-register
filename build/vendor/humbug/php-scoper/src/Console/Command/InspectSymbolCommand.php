...
use ACSB\Vendor\Fidry\Console\Command\CommandRegistry;
...
use ACSB\Vendor\Symfony\Component\Console\Application as DummyApplication;
...
final readonly class InspectSymbolCommand implements Command
{
    ...
    public function __construct(private Filesystem $fileSystem, private ConfigurationFactory $configFactory, private EnrichedReflectorFactory $enrichedReflectorFactory)
    {
    }
    ...
    private function retrieveConfig(IO $io, string $cwd): Configuration
    {
        ...
        return $configLoader->loadConfig(
            new IO($io->getInput(), new NullOutput()),
            '',
            $noConfig,
            $configFilePath,
